...
const ChartsData = ({ moneyData, invoiceLoading }) => {
                ...
                <Card>
                    <CardHeader className="flex flex-col items-stretch space-y-0 border-b p-0 sm:flex-row">
                        <div className="flex flex-1 flex-col gap-1 px-6 pt-4">
                            <CardTitle className="tracking-normal gap-2 text-lg flex items-center">
                            ...
                            <CardDescription className="tracking-wider pe-5 text-xs mt-1.5">
                            ...
                            {["sendedMoney", "recievedMoney", "spentMoney"].map((key) => {
                                return (
                                    <button
                                        ...
                                        className={`relative z-30 flex flex-1 flex-col justify-center gap-1 border-t px-3 py-2 md:px-6 md:py-4 mt-4 md:mt-0 text-left even:border-l data-[active=true]:bg-muted/50 sm:border-l sm:border-t-0 sm:px-8 sm:py-6 bg-gradient-to-tr transition-all duration-100 active:scale-90 
                                    ...
                                    >
                                        ...
                                        {invoiceLoading ?
                                            <div>
                                                <ImSpinner9 className="text-3xl mx-11 animate-spin" />
                                            </div>
                                            : <>
