...
const TbMoneyPaginate = ({ fullData, searchQuery, currentPage, setCurrentPage, isLoading }) => {
    ...
    return (<>
        {searchQuery ?
            ...
            :
            <div className='text-xs text-zinc-500 tracking-wide ps-2 flex gap-1 items-center'>Showing <span className='font-extrabold'>1-20</span> of <span className='font-extrabold'>47</span> entries</div>
        }
