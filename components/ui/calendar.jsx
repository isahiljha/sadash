...
function Calendar({
  ...
  return (
    (<DayPicker
      ...
      classNames={{
        months: "flex md:flex-col flex-row space-y-4 sm:space-x-4 sm:space-y-0",
        month: "space-y-4",
        ...
        day_today: "bg-zinc-100 text-zinc-900 aria-selected:text-white dark:bg-zinc-800 dark:text-zinc-50",
        day_outside:
